...
- 대상: `analysis\truncation\tokenization_results_127.csv` (1296 행)
- git commit: `1a6599be00b92e25f19c3ed4f1a8ba3ec2e2b0fe`
- 생성 시각: 2026-07-31T20:52:40.915877+00:00
...
| SGuard-ContentFilter-2B-v1|constrained_77: 절단이 실제로 발생 | PASS | visibility=none 240행 |
...
| 조건 1 실제 입력이 native context 미만 | PASS | 최대 2148 < 131072 |
| 조건 간 불변량 유지 | PASS | 0건 |
...
| SGuard-ContentFilter-2B-v1 (constrained_77) | 189 | 3 | 240 |
| AltDiffusion-m18 (native) | 220 | 0 | 212 |

- prompt 잘렸지만 key full: 319행
- 절단이 key 글자 중간 통과: 1행
