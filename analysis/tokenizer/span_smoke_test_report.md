...
|---|---|---|---|---|---|---|---|---|---|---|
| SGuard native | 20 | 7 | [0:6] | 0.150 | 20 | False | 7 | 1.000 | 1.000 | **full** |
| SGuard constrained_77 | 20 | 7 | [0:6] | 0.150 | 20 | False | 7 | 1.000 | 1.000 | **full** |
| AltDiffusion native | 11 | 4 | [0:3] | 0.136 | 11 | False | 4 | 1.000 | 1.000 | **full** |
...
| condition | pretrunc | key tok | key span | center | used | prompt_trunc | retained | ratio(tok) | ratio(char) | visibility |
|---|---|---|---|---|---|---|---|---|---|---|
| SGuard native | 36 | 23 | [0:22] | 0.306 | 36 | False | 23 | 1.000 | 1.000 | **full** |
| SGuard constrained_77 | 36 | 23 | [0:22] | 0.306 | 36 | False | 23 | 1.000 | 1.000 | **full** |
| AltDiffusion native | 24 | 17 | [0:16] | 0.333 | 24 | False | 17 | 1.000 | 1.000 | **full** |
...
| condition | pretrunc | key tok | key span | center | used | prompt_trunc | retained | ratio(tok) | ratio(char) | visibility |
|---|---|---|---|---|---|---|---|---|---|---|
| SGuard native | 17 | 4 | [12:15] | 0.794 | 17 | False | 4 | 1.000 | 1.000 | **full** |
| SGuard constrained_77 | 17 | 4 | [12:15] | 0.794 | 17 | False | 4 | 1.000 | 1.000 | **full** |
| AltDiffusion native | 10 | 3 | [6:8] | 0.700 | 10 | False | 3 | 1.000 | 1.000 | **full** |
...
| condition | pretrunc | key tok | key span | center | used | prompt_trunc | retained | ratio(tok) | ratio(char) | visibility |
|---|---|---|---|---|---|---|---|---|---|---|
| SGuard native | 110 | 5 | [58:62] | 0.545 | 110 | False | 5 | 1.000 | 1.000 | **full** |
| SGuard constrained_77 | 110 | 5 | [58:62] | 0.545 | 77 | True | 5 | 1.000 | 1.000 | **full** |
| AltDiffusion native | 68 | 5 | [34:38] | 0.529 | 68 | False | 5 | 1.000 | 1.000 | **full** |
...
| AltDiffusion native | 68 | 5 | [62:66] | 0.941 | 68 | False | 5 | 1.000 | 1.000 | **full** |
...
| condition | pretrunc | key tok | key span | center | used | prompt_trunc | retained | ratio(tok) | ratio(char) | visibility |
|---|---|---|---|---|---|---|---|---|---|---|
| SGuard native | 111 | 6 | [104:109] | 0.959 | 111 | False | 6 | 1.000 | 1.000 | **full** |
| SGuard constrained_77 | 111 | 6 | [104:109] | 0.959 | 77 | True | 0 | 0.000 | 0.000 | **none** |
| AltDiffusion native | 67 | 4 | [62:65] | 0.948 | 67 | False | 4 | 1.000 | 1.000 | **full** |
...
| AltDiffusion native | 267 | 5 | [0:4] | 0.007 | 75 | True | 5 | 1.000 | 1.000 | **full** |
...
| condition | pretrunc | key tok | key span | center | used | prompt_trunc | retained | ratio(tok) | ratio(char) | visibility |
|---|---|---|---|---|---|---|---|---|---|---|
| SGuard native | 403 | 6 | [201:206] | 0.505 | 403 | False | 6 | 1.000 | 1.000 | **full** |
| SGuard constrained_77 | 403 | 6 | [201:206] | 0.505 | 77 | True | 0 | 0.000 | 0.000 | **none** |
| AltDiffusion native | 267 | 5 | [147:151] | 0.558 | 75 | True | 0 | 0.000 | 0.000 | **none** |
